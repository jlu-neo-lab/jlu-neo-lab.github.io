...
const researchDetails = {
  ...
  "dual-operation-aggregation": {
    ...
    abstract:
      "This paper proposes a novel approach using Dual Operation Aggregation Graph Neural Networks combined with reinforcement learning to tackle the Flexible Job-Shop Scheduling Problem, aiming to optimize manufacturing processes efficiently.",
  ...
  "efficient-diffusion-solver": {
    ...
    abstract:
      "We introduce a diffusion-based, non-autoregressive solver for the Traveling Salesman Problem that significantly accelerates solution generation while maintaining high accuracy, making it suitable for large-scale logistics and planning.",
  ...
  "distilling-autoregressive-models": {
    ...
    abstract:
      "This work explores the distillation of autoregressive models into faster, non-autoregressive solvers for vehicle routing problems, achieving a new state-of-the-art in performance versus inference time.",
  ...
  "reinforcement-learning-solver": {
    ...
    abstract:
      "A reinforcement learning framework is presented for training a non-autoregressive solver for the Traveling Salesman Problem, which improves upon existing methods by learning better heuristics directly from data.",
  ...
  "neural-architecture-search": {
    ...
    abstract:
      "This study demonstrates an efficient neural architecture search method based on Cartesian Genetic Programming for text classification, specifically designed to operate under constrained computational budgets.",
  ...
  "incorporating-surprisingly-popular": {
    ...
    abstract:
      'We enhance Particle Swarm Optimization (PSO) by integrating the "surprisingly popular" algorithm and an adaptive topology based on Euclidean distance, leading to improved performance in complex optimization landscapes.',
    paperLink:
